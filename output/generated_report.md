...
**Data Source:** ICSR safety reports

**Analysis Method:** Deterministic Python and Pandas analysis
...
The supplied dataset contains **1068 records** representing
**1024 unique safety cases**.
...
- Patient reports were predominantly represented in the **60–74** and
  **75+** age groups.
- The reporting dataset covers the period from **2024-12-27 to
  2025-12-26**.
